...
def load_model_and_data():
    ...
    if os.path.exists(\"restaurants_clean.csv\"):
        ...
        data = [
            {\"name\":\"Shin-Sen-Gumi Ramen\",\"categories\":\"Ramen, Japanese\",\"city\":\"Gardena\",\"stars\":4.5,\"review_count\":1823,\"price_label\":\"$$\",\"price_tier\":2,\"has_wifi\":False,\"outdoor_seating\":False,\"good_for_kids\":True,\"takes_reservations\":False,\"vegetarian_friendly\":False,\"latitude\":33.888,\"longitude\":-118.308},
            {\"name\":\"Guerrilla Tacos\",\"categories\":\"Mexican, Tacos, Street Food\",\"city\":\"Los Angeles\",\"stars\":4.3,\"review_count\":987,\"price_label\":\"$\",\"price_tier\":1,\"has_wifi\":False,\"outdoor_seating\":True,\"good_for_kids\":False,\"takes_reservations\":False,\"vegetarian_friendly\":False,\"latitude\":34.021,\"longitude\":-118.238},
            {\"name\":\"Howlin' Ray's\",\"categories\":\"Hot Chicken, Southern\",\"city\":\"Los Angeles\",\"stars\":4.5,\"review_count\":2341,\"price_label\":\"$$\",\"price_tier\":2,\"has_wifi\":False,\"outdoor_seating\":False,\"good_for_kids\":True,\"takes_reservations\":False,\"vegetarian_friendly\":False,\"latitude\":34.059,\"longitude\":-118.238},
            {\"name\":\"Providence\",\"categories\":\"Seafood, Fine Dining\",\"city\":\"Los Angeles\",\"stars\":4.7,\"review_count\":1456,\"price_label\":\"$$$$\",\"price_tier\":4,\"has_wifi\":True,\"outdoor_seating\":False,\"good_for_kids\":False,\"takes_reservations\":True,\"vegetarian_friendly\":False,\"latitude\":34.083,\"longitude\":-118.348},
            {\"name\":\"Bavel\",\"categories\":\"Middle Eastern, Mediterranean\",\"city\":\"Los Angeles\",\"stars\":4.5,\"review_count\":1345,\"price_label\":\"$$$\",\"price_tier\":3,\"has_wifi\":True,\"outdoor_seating\":False,\"good_for_kids\":False,\"takes_reservations\":True,\"vegetarian_friendly\":False,\"latitude\":34.044,\"longitude\":-118.238},
            {\"name\":\"Night + Market Song\",\"categories\":\"Thai, Asian, Bar\",\"city\":\"Los Angeles\",\"stars\":4.3,\"review_count\":1788,\"price_label\":\"$$\",\"price_tier\":2,\"has_wifi\":True,\"outdoor_seating\":True,\"good_for_kids\":False,\"takes_reservations\":False,\"vegetarian_friendly\":False,\"latitude\":34.094,\"longitude\":-118.325},
            {\"name\":\"Pine & Crane\",\"categories\":\"Taiwanese, Asian, Vegetarian\",\"city\":\"Los Angeles\",\"stars\":4.4,\"review_count\":934,\"price_label\":\"$$\",\"price_tier\":2,\"has_wifi\":True,\"outdoor_seating\":False,\"good_for_kids\":True,\"takes_reservations\":False,\"vegetarian_friendly\":True,\"latitude\":34.094,\"longitude\":-118.272},
            {\"name\":\"Sonoratown\",\"categories\":\"Mexican, Tacos, Fast Food\",\"city\":\"Los Angeles\",\"stars\":4.5,\"review_count\":1122,\"price_label\":\"$\",\"price_tier\":1,\"has_wifi\":False,\"outdoor_seating\":False,\"good_for_kids\":True,\"takes_reservations\":False,\"vegetarian_friendly\":False,\"latitude\":34.055,\"longitude\":-118.245},
            {\"name\":\"Dama\",\"categories\":\"Mexican, Fine Dining, Cocktail Bars\",\"city\":\"Los Angeles\",\"stars\":4.4,\"review_count\":678,\"price_label\":\"$$$\",\"price_tier\":3,\"has_wifi\":True,\"outdoor_seating\":True,\"good_for_kids\":False,\"takes_reservations\":True,\"vegetarian_friendly\":False,\"latitude\":34.044,\"longitude\":-118.252},
            {\"name\":\"Langer's Delicatessen\",\"categories\":\"Delis, Sandwiches, Jewish\",\"city\":\"Los Angeles\",\"stars\":4.4,\"review_count\":3412,\"price_label\":\"$$\",\"price_tier\":2,\"has_wifi\":True,\"outdoor_seating\":False,\"good_for_kids\":True,\"takes_reservations\":False,\"vegetarian_friendly\":False,\"latitude\":34.060,\"longitude\":-118.273},
        ]
